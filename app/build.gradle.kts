...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 35
        versionCode = providers.environmentVariable("WORDTILES_VERSION_CODE").map(String::toInt).orElse(1).get()
        versionName = providers.environmentVariable("WORDTILES_VERSION_NAME").orElse("0.1.0").get()
